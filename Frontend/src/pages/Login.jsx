 ...
 * Features:
 * - Clean, focused single-hero section highlighting CRM project features
 * - Frictionless quick-fill demo credentials
 * - Caps Lock warning and shake error feedback
 * - Lush emerald container and 3D dashboard mockup
 */
const Login = () => {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden flex flex-col lg:flex-row bg-white font-sans select-none selection:bg-emerald-500/20">
      ...
      <div className="hidden lg:flex flex-1 h-full p-3 sm:p-4 pl-0 overflow-hidden">
        <div className="w-full h-full rounded-[28px] xl:rounded-[36px] bg-gradient-to-br from-[#22c55e] via-[#16a34a] to-[#15803d] p-8 xl:p-12 relative overflow-hidden flex flex-col justify-between text-white shadow-inner">
          ...
          {/* Top Headline Section (Single Focused Project Content) */}
          <div className="relative z-10 max-w-lg">
            {/* Value Prop Tag Badge */}
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/15 backdrop-blur-md text-[10px] font-semibold uppercase tracking-wider text-emerald-100 mb-3.5 border border-white/15 shadow-xs">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-300 animate-pulse"></span>
              Mini Sales CRM Workspace
            </div>

            <h2 className="text-2xl xl:text-3xl font-bold text-white tracking-tight leading-snug mb-2.5">
              Grow your business with smarter sales
            </h2>
            <p className="text-xs xl:text-sm text-emerald-100/90 font-normal leading-relaxed max-w-md">
              Manage client accounts, track inbound leads, and accelerate opportunity pipelines from a single intuitive workspace.
            </p>
          </div>
