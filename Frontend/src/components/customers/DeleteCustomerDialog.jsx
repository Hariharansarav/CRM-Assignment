 ...
 * Confirmation dialog for safely deleting a customer record.
 */
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500 mt-1">
              Are you sure you want to delete <strong className="text-slate-800">{customer.name}</strong>? This action cannot be undone and will remove the customer record.
            </p>
          </div>
        </div>
